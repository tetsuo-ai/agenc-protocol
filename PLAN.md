...
> **Historical planning record (banner added 2026-07-17, live pointer updated 2026-08-23).** This roadmap is a dated planning document, not current state. Mainnet has run the 101-instruction revision-5 surface (`surface_revision = 5`) since 2026-07-22. See `docs/MAINNET_MAINLINE.md` for live state and `docs/audit/ENTERPRISE_REMEDIATION_2026-07.md` for the completed remediation record. Dated body claims (surface sizes, gates, phases) are kept as written.
