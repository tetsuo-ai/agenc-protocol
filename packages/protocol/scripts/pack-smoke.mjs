...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import daemonSchemaJson from "@tetsuo-ai/protocol/daemon-json-rpc.schema.json" with { type: "json" };',
      ...
      "}",
      'if (daemonSchemaJson.$id !== "urn:agenc:app-server:protocol") {',
      '  throw new Error("Daemon JSON-RPC schema export mismatch");',
      "}",
  ...
  await writeFile(
    ...
    [
      ...
      'const daemonSchemaJson = require("@tetsuo-ai/protocol/daemon-json-rpc.schema.json");',
      ...
      "}",
      'if (daemonSchemaJson.$id !== "urn:agenc:app-server:protocol") {',
      '  throw new Error("CJS daemon JSON-RPC schema export mismatch");',
      "}",
      'if (verifierJson.address !== VERIFIER_ROUTER_IDL.address) {',
