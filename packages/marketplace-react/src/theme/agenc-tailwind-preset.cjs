 ...
 *                HEAD and update the commit line above.
 * ============================================================================
 */
...
const backgroundImage = {
  'agenc-gradient': 'linear-gradient(135deg, #7B3FFF 0%, #FF2E93 60%, #FF6B1A 100%)',
  'agenc-gradient-cool': 'linear-gradient(135deg, #48C8EF 0%, #7B3FFF 100%)',
  'agenc-gradient-text': 'linear-gradient(90deg, #7B3FFF 0%, #FF2E93 50%, #FF6B1A 100%)',
...
const boxShadow = {
  'glow-violet': '0 0 24px rgba(123, 63, 255, 0.4), 0 0 48px rgba(123, 63, 255, 0.2)',
  'glow-magenta': '0 0 24px rgba(255, 46, 147, 0.4), 0 0 48px rgba(255, 46, 147, 0.2)',
  'glow-cyan': '0 0 24px rgba(72, 200, 239, 0.4), 0 0 48px rgba(72, 200, 239, 0.2)',
  'glow-orange': '0 0 24px rgba(255, 107, 26, 0.4), 0 0 48px rgba(255, 107, 26, 0.2)',
  'glow-akira': '0 0 24px rgba(227, 4, 38, 0.5), 0 0 64px rgba(227, 4, 38, 0.25)',
};

const fontFamily = {
  // Display: jagged / glitch / cyberpunk. Pick one and load via @font-face.
  'agenc-display': ['"Audiowide"', '"Major Mono Display"', 'system-ui', 'sans-serif'],
  // Body: clean geometric sans
  'agenc-body': ['"Geist"', '"Inter"', 'system-ui', 'sans-serif'],
  // Mono: for HUD / status / readouts
  'agenc-mono': ['"JetBrains Mono"', '"IBM Plex Mono"', 'ui-monospace', 'monospace'],
};
...
const tetsuoPlugin = plugin(function ({ addUtilities, addComponents }) {
  addUtilities({
    ...
    '.text-glitch-strong': {
      position: 'relative',
      color: '#F8F5E9',
      textShadow: '3px 0 0 #48C8EF, -3px 0 0 #D01D7D, 0 0 8px rgba(255,255,255,0.15)',
    },
