...
export const CREATE_DIRECT_ASSIGNMENT_TASK_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([197, 16, 37, 117, 65, 18, 112, 237]);

export function getCreateDirectAssignmentTaskDiscriminatorBytes(): ReadonlyUint8Array {
  return getFixedBytesEncoder(8).encode(
    CREATE_DIRECT_ASSIGNMENT_TASK_DISCRIMINATOR,
  );
}

export type CreateDirectAssignmentTaskInstruction<
...
export type CreateDirectAssignmentTaskInstructionData = {
...
export type CreateDirectAssignmentTaskInstructionDataArgs = {
  taskId: ReadonlyUint8Array;
...
export function getCreateDirectAssignmentTaskInstructionDataEncoder(): Encoder<CreateDirectAssignmentTaskInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CREATE_DIRECT_ASSIGNMENT_TASK_DISCRIMINATOR,
    }),
  );
}

export function getCreateDirectAssignmentTaskInstructionDataDecoder(): Decoder<CreateDirectAssignmentTaskInstructionData> {
...
export function getCreateDirectAssignmentTaskInstructionDataCodec(): Codec<
  CreateDirectAssignmentTaskInstructionDataArgs,
  CreateDirectAssignmentTaskInstructionData
> {
  return combineCodec(
    getCreateDirectAssignmentTaskInstructionDataEncoder(),
    getCreateDirectAssignmentTaskInstructionDataDecoder(),
  );
}

export type CreateDirectAssignmentTaskAsyncInput<
...
> = {
  ...
  taskId: CreateDirectAssignmentTaskInstructionDataArgs["taskId"];
  requiredCapabilities: CreateDirectAssignmentTaskInstructionDataArgs["requiredCapabilities"];
  description: CreateDirectAssignmentTaskInstructionDataArgs["description"];
  rewardAmount: CreateDirectAssignmentTaskInstructionDataArgs["rewardAmount"];
  maxWorkers: CreateDirectAssignmentTaskInstructionDataArgs["maxWorkers"];
  deadline: CreateDirectAssignmentTaskInstructionDataArgs["deadline"];
  taskType: CreateDirectAssignmentTaskInstructionDataArgs["taskType"];
  constraintHash: CreateDirectAssignmentTaskInstructionDataArgs["constraintHash"];
  minReputation: CreateDirectAssignmentTaskInstructionDataArgs["minReputation"];
  rewardMintArg: CreateDirectAssignmentTaskInstructionDataArgs["rewardMint"];
  referrer: CreateDirectAssignmentTaskInstructionDataArgs["referrer"];
  referrerFeeBps: CreateDirectAssignmentTaskInstructionDataArgs["referrerFeeBps"];
};

export async function getCreateDirectAssignmentTaskInstructionAsync<
  TAccountTask extends string,
  TAccountEscrow extends string,
  TAccountProtocolConfig extends string,
  TAccountCreatorAgent extends string,
...
>(
  ...
  CreateDirectAssignmentTaskInstruction<
    TProgramAddress,
    TAccountTask,
    TAccountEscrow,
    TAccountProtocolConfig,
...
> {
  ...
  return Object.freeze({
    ...
    data: getCreateDirectAssignmentTaskInstructionDataEncoder().encode(
      args as CreateDirectAssignmentTaskInstructionDataArgs,
    ),
    programAddress,
  } as CreateDirectAssignmentTaskInstruction<
    TProgramAddress,
    TAccountTask,
    TAccountEscrow,
    TAccountProtocolConfig,
...
export type CreateDirectAssignmentTaskInput<
  TAccountTask extends string = string,
  TAccountEscrow extends string = string,
  TAccountProtocolConfig extends string = string,
  TAccountCreatorAgent extends string = string,
...
export function getCreateDirectAssignmentTaskInstruction<
  TAccountTask extends string,
  TAccountEscrow extends string,
  TAccountProtocolConfig extends string,
  TAccountCreatorAgent extends string,
...
export type ParsedCreateDirectAssignmentTaskInstruction<
  TProgram extends string = typeof AGENC_COORDINATION_PROGRAM_ADDRESS,
...
> = {
  ...
  data: CreateDirectAssignmentTaskInstructionData;
};

export function parseCreateDirectAssignmentTaskInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedCreateDirectAssignmentTaskInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getCreateDirectAssignmentTaskInstructionDataDecoder().decode(
      instruction.data,
    ),
  };
}
