...
> **Historical readiness record (banner added 2026-07-17).** The matrix status below is dated (2026-03-27); the release-1 gate it tracks has since shipped — mainnet has run the full 101-instruction revision-5 surface since 2026-07-22. See `./MAINNET_MAINLINE.md` for current state and `./audit/ENTERPRISE_REMEDIATION_2026-07.md` for the completed remediation record.
