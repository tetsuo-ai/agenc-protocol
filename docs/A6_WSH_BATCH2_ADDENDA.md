...
> **Historical design record (banner added 2026-07-17).** These stubs are a dated design document, not current state — see `./MAINNET_MAINLINE.md` for what is live and `../TODO.MD` for the completed remediation record.
